...
const RestarentCard = (props) => {
  ...
  return (
    <div className="card bg-base-100 shadow-md m-3 w-[200px] sm:w-[220px] md:w-[240px] min-h-[240px] rounded-xl overflow-hidden transform transition duration-300 hover:scale-105 mb-10">
